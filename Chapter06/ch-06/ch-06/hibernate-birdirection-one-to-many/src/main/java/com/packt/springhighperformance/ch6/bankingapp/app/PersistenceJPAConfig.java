...
public class PersistenceJPAConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl(this.env.getProperty("jdbc:postgresql://localhost:5432/TestDB"));
		dataSource.setUsername(this.env.getProperty("test"));
		dataSource.setPassword(this.env.getProperty("test"));
		return dataSource;
	}
